...
function bwlc_embed_script()
{
    ...
    if ($client_key) {
        echo '<script src="https://cdn.jsdelivr.net/gh/HeruPrasetia/cdn/livechat/livechat.js" domain-server="apps.bantuwin.id" client-key="' . $client_key . '" device-key="' . $device_key . '"></script>';
    }
}
?>