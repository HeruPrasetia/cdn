        ...
        <form method="post" action="options.php">
            ...
            <table class="form-table">
                ...
                <tr valign="top">
                    ...
                    <td>
                        <input type="text" name="bwlc_server_key" value="<?php echo esc_attr(get_option('bwlc_server_key')); ?>" />
                    </td>
                </tr>
            </table>
            <?php submit_button(); ?>
...
function bwlc_settings_init()
{
    ...
    register_setting('bwlc_settings_group', 'bwlc_server_key');
}
...
function bwlc_embed_script()
{
    ...
    if ($client_key) {
        echo '<script src="https://cdn.jsdelivr.net/gh/HeruPrasetia/cdn/livechat/livechat.js" client-key="' . $client_key . '" device-key="'. $device_key.'"></script>';
    }
}
?>